{# dbt run-operation --quiet stg_eff_type_3_to_type_2 --args '{"source_name": "fis", "table_name": "frrbasi", "alphabetize": true}' #}

{% macro stg_eff_type_3_to_type_2(source_name, table_name, partition_columns, alphabetize=true) %}
...
{%- if execute -%}
    {{ print(stg_eff_type_3_to_type_2) }}
    {%- do return(stg_eff_type_3_to_type_2) -%}
{%- endif -%}
